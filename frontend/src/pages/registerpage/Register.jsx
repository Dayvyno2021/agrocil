...
const Register = () => {
  ...
  const handleRegister = (e) => {
    e.preventDefault();
    dispatch(registerAction({ username, email, psw, refCode, phone, firstname, lastname }));
    
  }
  
  const disableRegister = () => {
    if (!username || !email || !psw || !cpassword || !phone || !lastname || !firstname) return true;
    return false;
  }
        ...
        <Grid md={6} item sx={reg.register} container direction='column'>
          ...
          >
            <Grid item container direction='row' >
              <Grid item container xs={11}>
                ...
                <TextField variant="outlined" type='text' id='username'
                  ...
                  onChange={(e)=>setUsername(e.target.value)} minlength='5'
                />
              </Grid>
            </Grid>
            <Grid item container direction='row' >
              <Grid item container xs={11}>
                <PersonIcon sx={reg.icon} />
                <TextField variant="outlined" type='text' id='firstname'
                  placeholder="first name" autoComplete='true' required value={firstname}
            ...
            <Grid item container direction='row' >
              <Grid item container xs={11}>
                <PersonIcon sx={reg.icon} />
                <TextField variant="outlined" type='text' id='lastname'
                  placeholder="last name" autoComplete='true' required value={lastname}
